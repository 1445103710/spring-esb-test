...
public class MyPoolingconnectionProvider implements ConnectionProvider {
    ...
    /**
     * No parameter construction, must have [no other construction, you can not write]
     */
    ...
    /**
     * Initialization method, should be called after calling its setter
     */
    ...
    /*-------------------------------------------------
     *
     * setters If you need to, you can add some getters
     * ------------------------------------------------
     */
